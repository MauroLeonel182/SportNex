        ...
        <div class="contendor__todo">
            ...
            <div class="contenedor__login-register">
                ...
                <form action="?page=register" method="POST" class="formulario__register">
                    <h2>Registrarme</h2>
                    <input type="text" placeholder="Nombre" name="nombre" required oninput="validarSoloLetras(this)"
                        value="<?php echo isset($_POST['nombre']) ? htmlspecialchars($_POST['nombre']) : ''; ?>">
                    <input type="text" placeholder="Apellido" name="apellido" required oninput="validarSoloLetras(this)"
                    ...
                    <input type="text" placeholder="Nombre de usuario" name="nombre_usuario" required
                        oninput="validarSoloLetrasNumeros(this)"
