...
<body>
    <div class="container">
        ...
        <div class="reserva">
            <div>
                <span class="reserva-hora"><?= date('H:i:s', strtotime($reserva['hora_inicio'])) ?></span>
                <span class="reserva-cancha"><?= $reserva['cancha'] ?></span>
            </div>
            <div>
                <span class="reserva-hora-fin">Fin: <?= date('H:i:s', strtotime($reserva['hora_fin'])) ?></span>
                <span class="reserva-estado <?= strtolower($reserva['estado']) ?>">Estado: <?= $reserva['estado'] ?></span>
            </div>
